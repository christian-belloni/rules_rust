...
mod test {
    ...
    fn mock_supported_platform_triples() -> Arc<BTreeSet<TargetTriple>> {
        Arc::new(BTreeSet::from([
            ...
            TargetTriple::from_bazel("aarch64-pc-windows-gnu".to_owned()),
            ...
            TargetTriple::from_bazel("i686-pc-windows-gnu".to_owned()),
            ...
            TargetTriple::from_bazel("x86_64-pc-windows-gnu".to_owned()),
